...
|--------------|-------------------|----------|------------|
| `0000180F-0000-1000-8000-00805F9B34FB` | `00002A19-0000-1000-8000-00805F9B34FB` | Read, Notify | Уровень батареи (0-100%) |
| `12345678-1234-1234-1234-123456789ABC` | `12345678-1234-1234-1234-123456789ABD` | Write, Notify | Командная характеристика |
| `12345678-1234-1234-1234-123456789ABC` | `12345678-1234-1234-1234-123456789ABE` | Read, Write | Данные устройства (серийный номер, версия) |
| `12345678-1234-1234-1234-123456789ABC` | `12345678-1234-1234-1234-123456789ABF` | Write, Notify | OTA обновления |
| `12345678-1234-1234-1234-123456789ABC` | `12345678-1234-1234-1234-123456789AC0` | Write, Notify | Загрузка анимаций |
...
#### 1.2.2. Команды управления анимацией
...
#### 1.2.5. Команды загрузки анимаций

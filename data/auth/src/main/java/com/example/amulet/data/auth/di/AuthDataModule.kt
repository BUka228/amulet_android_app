...
import com.example.amulet.data.auth.datasource.remote.FirebaseAuthDataSource
...
interface AuthDataModule {
    ...
    @Binds
    @Singleton
    fun bindAuthRemoteDataSource(impl: FirebaseAuthDataSource): AuthRemoteDataSource
